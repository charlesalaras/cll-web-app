...
export default function TrueFalseQuestion(props: QuestionProps) {
    ...
    function checkAnswer(e: any) {
        ...
        if(answer === String(data.correct).toLowerCase()) {
            currCorrect = true;
            calcScore = 1;
        }
        // Send record
    ...
    <>
        ...
        <RadioGroup>
        <FormControlLabel value="true" control={<Radio />} label="True" onChange={handleRadioChange}/>
        <FormControlLabel value="false" control={<Radio />} label="False" onChange={handleRadioChange}/>
        </RadioGroup>
